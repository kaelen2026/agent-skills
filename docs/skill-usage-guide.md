...
> 本文档演示如何在一个真实需求中，串联使用 agent-skills 项目的 20 个 skill，从需求分析到代码交付的完整流程。
>
> **新手？** 建议先用 `tutorial` skill 进行交互式引导练习，再回来查阅本文档。
...
10. **新手用 `tutorial` 入门** — 交互式引导练习，15 分钟体验核心流程，比直接读本文档更高效
